...
pdf("/Users/ds/Desktop/plot.pdf", width = 10, height = 12)
DoHeatmap(object = liver, features = order$gene) + theme(text = element_text(size = 20))
dev.off()
...
ggsave(filename = "/Users/ds/Desktop/plot.pdf", plot = p, width = 13, height = 10)
