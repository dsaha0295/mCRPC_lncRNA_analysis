---
title: "Gene plot of COLCA1 (AR associated lncRNA) - Figure 4"
...
plotTracks(list(gtrack, dTrack,arbtrack,frbtrack, atactrack, atrack,grtrack), from = start(target) -10000, to = end(target) + 10000, type = "histogram",ylim = c(-30,0)) + 
dev.off()
