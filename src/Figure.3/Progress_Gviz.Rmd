...
plotTracks(list(gtrack, dTrack,arbtrack, atactrack, atrack, grtrack), from = start(target), to = end(target), type = "histogram",ylim = c(-30,0), cex.title = 1.3, sizes=c(1,2,1,1,1,1))
dev.off()   
